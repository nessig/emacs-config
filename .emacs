...
;;          (lambda (output)
;;            (replace-regexp-in-string "\033\\[[0-9]+[GJ]" "" output)))))
;; ^[[1G> ^[[0K^[[3G
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(yaml-mode cider clojure-mode sqlplus csv-mode json-reformat tss scala-mode scala-mode2 auto-complete-clang restclient exec-path-from-shell zoom-frm w3m rainbow-delimiters haskell-mode js-comint nodejs-repl tern-auto-complete tern flycheck js2-refactor ac-js2 js2-mode magit jedi emmet-mode web-mode php-mode web-beautify solarized-theme slime)))
